...
// router.get('/getInvitedSpaces/:userId', authenticator.authenticateToken, controller.get_invited_workspaces_by_userid);
router.get('/getAll/:userId', authenticator.authenticateToken, controller.get_invited_workspaces_by_userid);
